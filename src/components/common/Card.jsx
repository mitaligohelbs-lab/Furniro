...
const Card = ({ src, name, subTitle, price, originalPrice, tag, id }) => {
  ...
  return (
    <button className="group relative cursor-pointer" onClick={handleCardClick}>
      <div className="relative">
        <img src={src} className="h-72 w-full object-cover" alt="Card Image" />
        {tag && (
          <span
            className={clsx(
      ...
      "
        >
          ...
          <div className="flex gap-4 text-white">
            ...
            <button
              className="flex gap-1 items-center disabled:cursor-not-allowed disabled:text-gray-300"
              onClick={(e) => {
                e.stopPropagation();
